...
export async function planQueries(
  ...
  return structured<QueryPlan>({
    system: [
      ...
      "- LINKEDIN: boolean people search (titles + skills, e.g. \"AI Engineer\" AND (LangChain OR n8n)).",
      "- JOBSDB/JOBBKK/JOBTHAI: short Thai/English keyword phrases a job board would match.",
      "- FACEBOOK: group/post keywords people use when posting their profile.",
      "- WEB: a Google-style query, prefer site: filters or distinctive skill phrases.",
